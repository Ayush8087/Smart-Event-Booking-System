-- Smart Event Booking System – MySQL schema
...
-- Drop existing tables for idempotent local setup (optional)
...
-- Sample seed data (feel free to modify)
...
ON DUPLICATE KEY UPDATE updated_at = CURRENT_TIMESTAMP; -- prevents duplicate inserts when rerun
